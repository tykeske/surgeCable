...
<html lang="en">
  <head runat="server">
    ...
    <title>Surge Cable INC. | Employee Contact Surge Cable INC.</title>
          ...
          <div class="col-md-5 probootstrap-animate" data-animate-effect="fadeIn">
            ...
            <form action="#" method="post" class="probootstrap-form" id="form1" runat="server">
              ...
              <div class="form-group">
                ...
                <asp:TextBox type="name" ID="employeeTextBox" class="form-control" required="required" runat="server"></asp:TextBox>
              </div>
              <div class="form-group">
