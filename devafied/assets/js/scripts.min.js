if (function (t, e) {
    ...
    function a() {
        (nt.addEventListener || "load" === t.event.type || "complete" === nt.readyState) && (r(), ht.ready())
    }
    ...
    function l(t, e, n) {
        if (void 0 === n && 1 === t.nodeType) {
            ...
            if ("string" == typeof (n = t.getAttribute(i))) {
                try {
                    n = "true" === n || "false" !== n && ("null" === n ? null : +n + "" === n ? +n : Dt.test(n) ? ht.parseJSON(n) : n)
                } catch (t) { }
                ht.data(t, e, n)
            } else n = void 0
        }
    ...
    function u(t, e, n, i) {
        if (At(t)) {
            var o, s, r = ht.expando,
                a = t.nodeType,
                l = a ? ht.cache : t,
                c = a ? t[r] : t[r] && r;
            if (c && l[c] && (i || l[c].data) || void 0 !== n || "string" != typeof e) return c || (c = a ? t[r] = et.pop() || ht.guid++ : r), l[c] || (l[c] = a ? {} : {
                toJSON: ht.noop
            }), "object" != typeof e && "function" != typeof e || (i ? l[c] = ht.extend(l[c], e) : l[c].data = ht.extend(l[c].data, e)), s = l[c], i || (s.data || (s.data = {}), s = s.data), void 0 !== n && (s[ht.camelCase(e)] = n), "string" == typeof e ? null == (o = s[e]) && (o = s[ht.camelCase(e)]) : o = s, o
        }
    }
    ...
    function d(t, e, n) {
        if (At(t)) {
            ...
            if (r[a]) {
                ...
                } (n || (delete r[a].data, c(r[a]))) && (s ? ht.cleanData([t], !0) : ut.deleteExpando || r != r.window ? delete r[a] : r[a] = void 0)
            }
        }
    }
    ...
    function f(t, e) {
        ...
        if (!s)
            for (s = [], n = t.childNodes || t; null != (i = n[o]); o++) !e || ht.nodeName(i, e) ? s.push(i) : ht.merge(s, f(i, e));
        return void 0 === e || e && ht.nodeName(t, e) ? ht.merge([t], s) : s
    }
    ...
    function v(t, e, n, i, o) {
        for (var s, r, a, l, c, u, d, h = t.length, v = p(e), y = [], w = 0; h > w; w++)
            if ((r = t[w]) || 0 === r)
                if ("object" === ht.type(r)) ht.merge(y, r.nodeType ? [r] : r);
                else if (Bt.test(r)) {
                    for (l = l || v.appendChild(e.createElement("div")), c = (zt.exec(r) || ["", ""])[1].toLowerCase(), d = Ft[c] || Ft._default, l.innerHTML = d[1] + ht.htmlPrefilter(r) + d[2], s = d[0]; s--;) l = l.lastChild;
                    if (!ut.leadingWhitespace && Wt.test(r) && y.push(e.createTextNode(Wt.exec(r)[0])), !ut.tbody)
                        for (s = (r = "table" !== c || Xt.test(r) ? "<table>" !== d[1] || Xt.test(r) ? 0 : l : l.firstChild) && r.childNodes.length; s--;) ht.nodeName(u = r.childNodes[s], "tbody") && !u.childNodes.length && r.removeChild(u);
                    for (ht.merge(y, l.childNodes), l.textContent = ""; l.firstChild;) l.removeChild(l.firstChild);
                    l = v.lastChild
                } else y.push(e.createTextNode(r));
        for (l && v.removeChild(l), ut.appendChecked || ht.grep(f(y, "input"), m), w = 0; r = y[w++];)
            if (i && ht.inArray(r, i) > -1) o && o.push(r);
            else if (a = ht.contains(r.ownerDocument, r), l = f(v.appendChild(r), "script"), a && g(l), n)
                for (s = 0; r = l[s++];) Rt.test(r.type || "") && n.push(r);
        return l = null, v
    }
    ...
    function E(t, e) {
        ...
        if (1 === e.nodeType) {
            ...
            "script" === n && e.text !== t.text ? (C(e).text = t.text, S(e)) : "object" === n ? (e.parentNode && (e.outerHTML = t.outerHTML), ut.html5Clone && t.innerHTML && !ht.trim(e.innerHTML) && (e.innerHTML = t.innerHTML)) : "input" === n && Ht.test(t.type) ? (e.defaultChecked = e.checked = t.checked, e.value !== t.value && (e.value = t.value)) : "option" === n ? e.defaultSelected = e.selected = t.defaultSelected : "input" !== n && "textarea" !== n || (e.defaultValue = t.defaultValue)
        }
    }
    ...
    function $(t, e, n, i) {
        ...
        if (g || d > 1 && "string" == typeof p && !ut.checkClone && ee.test(p)) return t.each(function (o) {
            var s = t.eq(o);
            g && (e[0] = p.call(this, o, s.html())), $(s, e, n, i)
        });
        if (d && (c = v(e, t[0].ownerDocument, !1, t, i), o = c.firstChild, 1 === c.childNodes.length && (c = o), o || i)) {
            for (r = (a = ht.map(f(c, "script"), C)).length; d > u; u++) s = c, u !== h && (s = ht.clone(s, !0, !0), r && ht.merge(a, f(s, "script"))), n.call(t[u], s, u);
            if (r)
                for (l = a[a.length - 1].ownerDocument, ht.map(a, S), u = 0; r > u; u++) s = a[u], Rt.test(s.type || "") && !ht._data(s, "globalEval") && ht.contains(l, s) && (s.src ? ht._evalUrl && ht._evalUrl(s.src) : ht.globalEval((s.text || s.textContent || s.innerHTML || "").replace(ie, "")));
            c = o = null
        }
        return t
    }
    ...
    function k(t, e, n) {
        for (var i, o = e ? ht.filter(e, t) : t, s = 0; null != (i = o[s]); s++) n || 1 !== i.nodeType || ht.cleanData(f(i)), i.parentNode && (n && ht.contains(i.ownerDocument, i) && g(f(i, "script")), i.parentNode.removeChild(i));
        return t
    }
    ...
    function A(t) {
        var e = nt,
            n = re[t];
        return n || ("none" !== (n = N(t, e)) && n || (se = (se || ht("<iframe frameborder='0' width='0' height='0'/>")).appendTo(e.documentElement), (e = (se[0].contentWindow || se[0].contentDocument).document).write(), e.close(), n = N(t, e), se.detach()), re[t] = n), n
    }
    ...
    function L(t, e) {
        for (var n, i, o, s = [], r = 0, a = t.length; a > r; r++)(i = t[r]).style && (s[r] = ht._data(i, "olddisplay"), n = i.style.display, e ? (s[r] || "none" !== n || (i.style.display = ""), "" === i.style.display && jt(i) && (s[r] = ht._data(i, "olddisplay", A(i.nodeName)))) : (o = jt(i), (n && "none" !== n || !o) && ht._data(i, "olddisplay", o ? n : ht.css(i, "display"))));
    ...
    function I(t, e, n, i, o) {
        for (var s = n === (i ? "border" : "content") ? 4 : "width" === e ? 1 : 0, r = 0; 4 > s; s += 2) "margin" === n && (r += ht.css(t, n + It[s], !0, o)), i ? ("content" === n && (r -= ht.css(t, "padding" + It[s], !0, o)), "margin" !== n && (r -= ht.css(t, "border" + It[s] + "Width", !0, o))) : (r += ht.css(t, "padding" + It[s], !0, o), "padding" !== n && (r += ht.css(t, "border" + It[s] + "Width", !0, o)));
        return r
    }
    ...
    function j(t, e, n) {
        var i = !0,
            ...
            s = de(t),
            r = ut.boxSizing && "border-box" === ht.css(t, "boxSizing", !1, s);
        if (0 >= o || null == o) {
            if ((0 > (o = he(t, e, s)) || null == o) && (o = t.style[e]), le.test(o)) return o;
            i = r && (ut.boxSizingReliable() || o === t.style[e]), o = parseFloat(o) || 0
        }
    ...
    function z(t, e) {
        var n, i = {
            ...
            o = 0;
        for (e = e ? 1 : 0; 4 > o; o += 2 - e) n = It[o], i["margin" + n] = i["padding" + n] = t;
        return e && (i.opacity = i.width = t), i
    }

    function R(t, e, n) {
        for (var i, o = (q.tweeners[e] || []).concat(q.tweeners["*"]), s = 0, r = o.length; r > s; s++)
    ...
    function W(t, e) {
        var n, i, o, s, r;
        for (n in t)
            if (i = ht.camelCase(n), o = e[i], s = t[n], ht.isArray(s) && (o = s[1], s = t[n] = s[0]), n !== i && (t[i] = s, delete t[n]), (r = ht.cssHooks[i]) && "expand" in r) {
    ...
    function q(t, e, n) {
        var i, o, s = 0,
            ...
            l = function () {
                if (o) return !1;
                for (var e = Te || H(), n = Math.max(0, c.startTime + c.duration - e), i = 1 - (n / c.duration || 0), s = 0, r = c.tweens.length; r > s; s++) c.tweens[s].run(i);
        ...
        for (W(u, c.opts.specialEasing); r > s; s++)
            if (i = q.prefilters[s].call(c, t, u, c.opts)) return ht.isFunction(i.stop) && (ht._queueHooks(c.elem, c.opts.queue).stop = ht.proxy(i.stop, i)), i;
        return ht.map(u, R, c), ht.isFunction(c.opts.start) && c.opts.start.call(t, c), ht.fx.timer(ht.extend(l, {
            elem: t,
            anim: c,
            queue: c.opts.queue
    ...
    function K(t, e, n, i) {
        ...
        if (ht.isArray(e)) ht.each(e, function (e, o) {
            n || tn.test(t) ? i(t, o) : K(t + "[" + ("object" == typeof o && null != o ? e : "") + "]", o, n, i)
        });
    ...
    ht.fn = ht.prototype = {
        ...
        var t, e, n, i, o, s, r = arguments[0] || {},
            ...
            l = arguments.length,
            c = !1;
        for ("boolean" == typeof r && (c = r, r = arguments[a] || {}, a++), "object" == typeof r || ht.isFunction(r) || (r = {}), a === l && (r = this, a--); l > a; a++)
            if (null != (o = arguments[a]))
                for (i in o) t = r[i], n = o[i], r !== n && (c && n && (ht.isPlainObject(n) || (e = ht.isArray(n))) ? (e ? (e = !1, s = t && ht.isArray(t) ? t : []) : s = t && ht.isPlainObject(t) ? t : {}, r[i] = ht.extend(c, s, n)) : void 0 !== n && (r[i] = n));
        return r
    }, ht.extend({
        ...
        map: function (t, e, i) {
            var o, s, r = 0,
                a = [];
            if (n(t))
                for (o = t.length; o > r; r++) null != (s = e(t[r], r, i)) && a.push(s);
            else
    ...
    var vt = function (t) {
        function e(t, e, n, i) {
            var o, s, r, a, c, d, h, p, f = e && e.ownerDocument,
                g = e ? e.nodeType : 9;
            ...
            if (!i && ((e ? e.ownerDocument || e : H) !== A && N(e), e = e || A, O)) {
                if (11 !== g && (d = gt.exec(t)))
                    if (o = d[1]) {
                        ...
                        } else if (f && (r = f.getElementById(o)) && j(e, r) && r.id === o) return n.push(r), n
                    } else {
                    ...
                    } if (w.qsa && !F[t + " "] && (!L || !L.test(t))) {
                        if (1 !== g) f = e, p = t;
                        else if ("object" !== e.nodeName.toLowerCase()) {
                            for ((a = e.getAttribute("id")) ? a = a.replace(vt, "\\$&") : e.setAttribute("id", a = M), s = (h = C(t)).length, c = ut.test(a) ? "#" + a : "[id='" + a + "']"; s--;) h[s] = c + " " + u(h[s]);
        ...
        function d(t, e, n) {
            ...
            return e.first ? function (e, n, s) {
                ...
                if (r) {
                    ...
                    for (; e = e[i];)
                        if (1 === e.nodeType || o) {
                            if (c = e[M] || (e[M] = {}), l = c[e.uniqueID] || (c[e.uniqueID] = {}), (a = l[i]) && a[0] === z && a[1] === s) return u[2] = a[2];
            ...
            return o && !o[M] && (o = g(o)), s && !s[M] && (s = g(s, r)), i(function (i, r, a, l) {
                ...
                if (i) {
                    if (s || t) {
                        ...
                        for (u = w.length; u--;)(d = w[u]) && (c = s ? Z(i, d) : h[u]) > -1 && (i[c] = !(r[c] = d))
                    }
        ...
        function m(t) {
            for (var e, n, i, o = t.length, s = b.relative[t[0].type], r = s || b.relative[" "], a = s ? 1 : 0, l = d(function (t) {
                return t === e
            }, r, !0), c = d(function (t) {
                return Z(e, t) > -1
            }, r, !0), p = [function (t, n, i) {
                var o = !s && (i || n !== E) || ((e = n).nodeType ? l(t, n, i) : c(t, n, i));
                return e = null, o
            }]; o > a; a++)
                if (n = b.relative[t[a].type]) p = [d(h(p), n)];
                else {
                    if ((n = b.filter[t[a].type].apply(null, t[a].matches))[M]) {
            ...
            var o = n.length > 0,
                ...
                r = function (i, r, a, l, c) {
                    var u, d, h, p = 0,
                        ...
                        T = w.length;
                    for (c && (E = r === A || r || c); g !== T && null != (u = w[g]); g++) {
                        if (s && u) {
                            for (d = 0, r || u.ownerDocument === A || (N(u), a = !O); h = t[d++];)
                                if (h(u, r || A, a)) {
                                    l.push(u);
                                    break
                                } c && (z = x)
        ...
        var y, w, b, x, T, C, S, _, E, $, k, N, A, D, O, L, P, I, j, M = "sizzle" + 1 * new Date,
            H = t.document,
            z = 0,
            R = 0,
            W = n(),
        ...
        try {
            G.apply(Q = K.call(H.childNodes), H.childNodes), Q[H.childNodes.length].nodeType
        } catch (t) {
            G = {
        ...
        w = e.support = {}, T = e.isXML = function (t) {
            ...
            return i !== A && 9 === i.nodeType && i.documentElement ? (A = i, D = A.documentElement, O = !T(A), (n = A.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", bt, !1) : n.attachEvent && n.attachEvent("onunload", bt)), w.attributes = o(function (t) {
                return t.className = "i", !t.getAttribute("className")
            }), w.getElementsByTagName = o(function (t) {
                return t.appendChild(A.createComment("")), !t.getElementsByTagName("*").length
            }), w.getElementsByClassName = ft.test(A.getElementsByClassName), w.getById = o(function (t) {
                return D.appendChild(t).id = M, !A.getElementsByName || !A.getElementsByName(M).length
            ...
            }, P = [], L = [], (w.qsa = ft.test(A.querySelectorAll)) && (o(function (t) {
            ...
            })), (w.matchesSelector = ft.test(I = D.matches || D.webkitMatchesSelector || D.mozMatchesSelector || D.oMatchesSelector || D.msMatchesSelector)) && o(function (t) {
                w.disconnectedMatch = I.call(t, "div"), I.call(t, "[s!='']:x"), P.push("!=", it)
            }), L = L.length && new RegExp(L.join("|")), P = P.length && new RegExp(P.join("|")), e = ft.test(D.compareDocumentPosition), j = e || ft.test(D.contains) ? function (t, e) {
                ...
                return n || (1 & (n = (t.ownerDocument || t) === (e.ownerDocument || e) ? t.compareDocumentPosition(e) : 1) || !w.sortDetached && e.compareDocumentPosition(t) === n ? t === A || t.ownerDocument === H && j(H, t) ? -1 : e === A || e.ownerDocument === H && j(H, e) ? 1 : $ ? Z($, t) - Z($, e) : 0 : 4 & n ? -1 : 1)
            } : function (t, e) {
                if (t === e) return k = !0, 0;
                var n, i = 0,
                    o = t.parentNode,
                    ...
                    a = [t],
                    l = [e];
                if (!o || !s) return t === A ? -1 : e === A ? 1 : o ? -1 : s ? 1 : $ ? Z($, t) - Z($, e) : 0;
                if (o === s) return r(t, e);
            ...
            if ((t.ownerDocument || t) !== A && N(t), n = n.replace(lt, "='$1']"), w.matchesSelector && O && !F[n + " "] && (!P || !P.test(n)) && (!L || !L.test(n))) try {
                var i = I.call(t, n);
                if (i || w.disconnectedMatch || t.document && 11 !== t.document.nodeType) return i
            } catch (t) { }
            return e(n, A, null, [t]).length > 0
        }, e.contains = function (t, e) {
            return (t.ownerDocument || t) !== A && N(t), j(t, e)
        }, e.attr = function (t, e) {
            (t.ownerDocument || t) !== A && N(t);
            var n = b.attrHandle[e.toLowerCase()],
                i = n && U.call(b.attrHandle, e.toLowerCase()) ? n(t, e, !O) : void 0;
            ...
            var e, n = [],
                i = 0,
                o = 0;
            if (k = !w.detectDuplicates, $ = !w.sortStable && t.slice(0), t.sort(B), k) {
            ...
            filter: {
                    ...
                    return 1 === i && 0 === o ? function (t) {
                        ...
                        if (m) {
                            ...
                            if (f = [r ? m.firstChild : m.lastChild], r && y) {
                                for (w = (p = (c = (u = (d = (h = m)[M] || (h[M] = {}))[h.uniqueID] || (d[h.uniqueID] = {}))[t] || [])[0] === z && c[1]) && c[2], h = p && m.childNodes[p]; h = ++p && h && h[g] || (w = p = 0) || f.pop();)
                                    if (1 === h.nodeType && ++w && h === e) {
                                        u[t] = [z, p, w];
                                        break
                                    }
                            } else if (y && (h = e, d = h[M] || (h[M] = {}), u = d[h.uniqueID] || (d[h.uniqueID] = {}), c = u[t] || [], p = c[0] === z && c[1], w = p), !1 === w)
                                for (;
                                    (h = ++p && h && h[g] || (w = p = 0) || f.pop()) && ((a ? h.nodeName.toLowerCase() !== v : 1 !== h.nodeType) || !++w || (y && (d = h[M] || (h[M] = {}), u = d[h.uniqueID] || (d[h.uniqueID] = {}), u[t] = [z, w]), h !== e)););
                ...
                PSEUDO: function (t, n) {
                    ...
                    return s[M] ? s(n) : s.length > 1 ? (o = [t, t, "", n], b.setFilters.hasOwnProperty(t.toLowerCase()) ? i(function (t, e) {
        ...
        return c.prototype = b.filters = b.pseudos, b.setFilters = new c, C = e.tokenize = function (t, n) {
            ...
            var n, i = [],
                ...
                s = F[t + " "];
            if (!s) {
                for (e || (e = C(t)), n = e.length; n--;)(s = m(e[n]))[M] ? i.push(s) : o.push(s);
                (s = F(t, v(o, i))).selector = t
            }
            return s
        }, _ = e.select = function (t, e, n, i) {
            var o, s, r, a, c, d = "function" == typeof t && t,
                h = !i && C(t = d.selector || t);
            if (n = n || [], 1 === h.length) {
                if ((s = h[0] = h[0].slice(0)).length > 2 && "ID" === (r = s[0]).type && w.getById && 9 === e.nodeType && O && b.relative[s[1].type]) {
                    if (!(e = (b.find.ID(r.matches[0].replace(yt, wt), e) || [])[0])) return n;
                    d && (e = e.parentNode), t = t.slice(s.shift().value.length)
                }
                for (o = dt.needsContext.test(t) ? 0 : s.length; o-- && (r = s[o], !b.relative[a = r.type]);)
                    if ((c = b.find[a]) && (i = c(r.matches[0].replace(yt, wt), mt.test(s[0].type) && l(e.parentNode) || e))) {
                        if (s.splice(o, 1), !(t = i.length && u(s))) return G.apply(n, i), n;
                        break
                    }
            }
            return (d || S(t, h))(i, e, !O, n, !e || mt.test(t) && l(e.parentNode) || e), n
        }, w.sortStable = M.split("").sort(B).join("") === M, w.detectDuplicates = !!k, N(), w.sortDetached = o(function (t) {
    ...
    ht.fn.extend({
        ...
        closest: function (t, e) {
            for (var n, i = 0, o = this.length, s = [], r = bt.test(t) || "string" != typeof t ? ht(t, e || this.context) : 0; o > i; i++)
                for (n = this[i]; n && n !== e; n = n.parentNode)
                    if (n.nodeType < 11 && (r ? r.index(n) > -1 : 1 === n.nodeType && ht.find.matchesSelector(n, t))) {
                        s.push(n);
                        break
    ...
    ht.Callbacks = function (t) {
            ...
            u = {
                ...
                remove: function () {
                    return ht.each(arguments, function (t, e) {
                        for (var n;
                            (n = ht.inArray(e, r, n)) > -1;) r.splice(n, 1), l >= n && l--
                    }), this
                },
                has: function (t) {
        ...
        Deferred: function (t) {
            var e = [
                ...
                i = {
                    ...
                    then: function () {
                        ...
                        return ht.Deferred(function (n) {
                            ht.each(e, function (e, s) {
                                var r = ht.isFunction(t[e]) && t[e];
                                o[s[1]](function () {
                                    var t = r && r.apply(this, arguments);
                                    t && ht.isFunction(t.promise) ? t.promise().progress(n.notify).done(n.resolve).fail(n.reject) : n[s[0] + "With"](this === i ? n.promise() : this, r ? [t] : arguments)
                                })
                            }), t = null
                        }).promise()
                    },
                ...
                o = {};
            return i.pipe = i.then, ht.each(e, function (t, s) {
                var r = s[2],
                    a = s[3];
        ...
        when: function (t) {
            ...
            if (r > 1)
                for (e = new Array(r), n = new Array(r), i = new Array(r); r > o; o++) s[o] && ht.isFunction(s[o].promise) ? s[o].promise().progress(c(o, n, e)).done(c(o, i, s)).fail(l.reject) : --a;
    ...
    ht.fn.ready = function (t) {
        ...
        ready: function (t) {
            (!0 === t ? --ht.readyWait : ht.isReady) || (ht.isReady = !0, !0 !== t && --ht.readyWait > 0 || (kt.resolveWith(nt, [ht]), ht.fn.triggerHandler && (ht(nt).triggerHandler("ready"), ht(nt).off("ready"))))
        }
    }), ht.ready.promise = function (e) {
        if (!kt)
            if (kt = ht.Deferred(), "complete" === nt.readyState || "loading" !== nt.readyState && !nt.documentElement.doScroll) t.setTimeout(ht.ready);
    ...
    ht.extend({
        ...
        data: function (t, e) {
            var n, i, o, s = this[0],
                r = s && s.attributes;
            if (void 0 === t) {
                if (this.length && (o = ht.data(s), 1 === s.nodeType && !ht._data(s, "parsedAttrs"))) {
                    for (n = r.length; n--;) r[n] && 0 === (i = r[n].name).indexOf("data-") && (i = ht.camelCase(i.slice(5)), l(s, i, o[i]));
        ...
        promise: function (t, e) {
            ...
            for ("string" != typeof t && (e = t, t = void 0), t = t || "fx"; r--;)(n = ht._data(s[r], t + "queueHooks")) && n.empty && (i++, n.empty.add(a));
    ...
    var Lt = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,
        ...
        Mt = function (t, e, n, i, o, s, r) {
            var a = 0,
                l = t.length,
                c = null == n;
            if ("object" === ht.type(n)) {
                o = !0;
                for (a in n) Mt(t, e, a, n[a], !0, s, r)
    ...
    ht.event = {
        ...
        add: function (t, e, n, i, o) {
            var s, r, a, l, c, u, d, h, p, f, g, m = ht._data(t);
            if (m) {
                for (n.handler && (l = n, n = l.handler, o = l.selector), n.guid || (n.guid = ht.guid++), (r = m.events) || (r = m.events = {}), (u = m.handle) || (u = m.handle = function (t) {
                    return void 0 === ht || t && ht.event.triggered === t.type ? void 0 : ht.event.dispatch.apply(u.elem, arguments)
                }, u.elem = t), a = (e = (e || "").match($t) || [""]).length; a--;) s = Gt.exec(e[a]) || [], p = g = s[1], f = (s[2] || "").split(".").sort(), p && (c = ht.event.special[p] || {}, p = (o ? c.delegateType : c.bindType) || p, c = ht.event.special[p] || {}, d = ht.extend({
                    type: p,
                    origType: g,
                    data: i,
                    handler: n,
                    ...
                    namespace: f.join(".")
                }, l), (h = r[p]) || (h = r[p] = [], h.delegateCount = 0, c.setup && !1 !== c.setup.call(t, i, f, u) || (t.addEventListener ? t.addEventListener(p, u, !1) : t.attachEvent && t.attachEvent("on" + p, u))), c.add && (c.add.call(t, d), d.handler.guid || (d.handler.guid = n.guid)), o ? h.splice(h.delegateCount++, 0, d) : h.push(d), ht.event.global[p] = !0);
                t = null
            }
        },
        remove: function (t, e, n, i, o) {
            var s, r, a, l, c, u, d, h, p, f, g, m = ht.hasData(t) && ht._data(t);
            if (m && (u = m.events)) {
                for (c = (e = (e || "").match($t) || [""]).length; c--;)
                    if (a = Gt.exec(e[c]) || [], p = g = a[1], f = (a[2] || "").split(".").sort(), p) {
                        for (d = ht.event.special[p] || {}, h = u[p = (i ? d.delegateType : d.bindType) || p] || [], a = a[2] && new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)"), l = s = h.length; s--;) r = h[s], !o && g !== r.origType || n && n.guid !== r.guid || a && !a.test(r.namespace) || i && i !== r.selector && ("**" !== i || !r.selector) || (h.splice(s, 1), r.selector && h.delegateCount--, d.remove && d.remove.call(t, r));
        ...
        trigger: function (e, n, i, o) {
            ...
            if (a = u = i = i || nt, 3 !== i.nodeType && 8 !== i.nodeType && !Yt.test(p + ht.event.triggered) && (p.indexOf(".") > -1 && (f = p.split("."), p = f.shift(), f.sort()), r = p.indexOf(":") < 0 && "on" + p, e = e[ht.expando] ? e : new ht.Event(p, "object" == typeof e && e), e.isTrigger = o ? 2 : 3, e.namespace = f.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = i), n = null == n ? [e] : ht.makeArray(n, [e]), c = ht.event.special[p] || {}, o || !c.trigger || !1 !== c.trigger.apply(i, n))) {
                ...
                for (d = 0;
                    (a = h[d++]) && !e.isPropagationStopped();) e.type = d > 1 ? l : c.bindType || p, (s = (ht._data(a, "events") || {})[e.type] && ht._data(a, "handle")) && s.apply(a, n), (s = r && a[r]) && s.apply && At(a) && (e.result = s.apply(a, n), !1 === e.result && e.preventDefault());
                if (e.type = p, !o && !e.isDefaultPrevented() && (!c._default || !1 === c._default.apply(h.pop(), n)) && At(i) && r && i[p] && !ht.isWindow(i)) {
                    (u = i[r]) && (i[r] = null), ht.event.triggered = p;
                    try {
                        i[p]()
                    } catch (t) { }
                    ht.event.triggered = void 0, u && (i[r] = u)
                }
                return e.result
            }
        },
        dispatch: function (t) {
            ...
            if (a[0] = t, t.delegateTarget = this, !c.preDispatch || !1 !== c.preDispatch.call(this, t)) {
                for (r = ht.event.handlers.call(this, t, l), e = 0;
                    (o = r[e++]) && !t.isPropagationStopped();)
                    for (t.currentTarget = o.elem, n = 0;
                        (s = o.handlers[n++]) && !t.isImmediatePropagationStopped();) t.rnamespace && !t.rnamespace.test(s.namespace) || (t.handleObj = s, t.data = s.data, void 0 !== (i = ((ht.event.special[s.origType] || {}).handle || s.handler).apply(o.elem, a)) && !1 === (t.result = i) && (t.preventDefault(), t.stopPropagation()));
            ...
            if (a && l.nodeType && ("click" !== t.type || isNaN(t.button) || t.button < 1))
                for (; l != this; l = l.parentNode || this)
                    if (1 === l.nodeType && (!0 !== l.disabled || "click" !== t.type)) {
                        for (i = [], n = 0; a > n; n++) s = e[n], o = s.selector + " ", void 0 === i[o] && (i[o] = s.needsContext ? ht(o, this).index(l) > -1 : ht.find(o, this, null, [l]).length), i[o] && i.push(s);
                        i.length && r.push({
                            elem: l,
                            handlers: i
                        })
        ...
        fix: function (t) {
            ...
            var e, n, i, o = t.type,
                s = t,
                r = this.fixHooks[o];
            for (r || (this.fixHooks[o] = r = Vt.test(o) ? this.mouseHooks : Qt.test(o) ? this.keyHooks : {}), i = r.props ? this.props.concat(r.props) : this.props, t = new ht.Event(s), e = i.length; e--;) n = i[e], t[n] = s[n];
        ...
        setup: function () {
            return Ut.test(this.nodeName) ? ("checkbox" !== this.type && "radio" !== this.type || (ht.event.add(this, "propertychange._change", function (t) {
                ...
                var e = t.target;
                Ut.test(e.nodeName) && !ht._data(e, "change") && (ht.event.add(e, "change._change", function (t) {
        ...
        teardown: function () {
            return ht.event.remove(this, "._change"), !Ut.test(this.nodeName)
        }
    }), ut.focusin || ht.each({
        focus: "focusin",
        blur: "focusout"
    ...
    ht.extend({
        ...
        clone: function (t, e, n) {
            var i, o, s, r, a, l = ht.contains(t.ownerDocument, t);
            if (ut.html5Clone || ht.isXMLDoc(t) || !Zt.test("<" + t.nodeName + ">") ? s = t.cloneNode(!0) : (oe.innerHTML = t.outerHTML, oe.removeChild(s = oe.firstChild)), !(ut.noCloneEvent && ut.noCloneChecked || 1 !== t.nodeType && 11 !== t.nodeType || ht.isXMLDoc(t)))
                for (i = f(s), a = f(t), r = 0; null != (o = a[r]); ++r) i[r] && E(o, i[r]);
            if (e)
                if (n)
                    for (a = a || f(t), i = i || f(s), r = 0; null != (o = a[r]); r++) _(o, i[r]);
                else _(t, s);
            return (i = f(s, "script")).length > 0 && g(i, !l && f(t, "script")), i = a = o = null, s
        },
        cleanData: function (t, e) {
            for (var n, i, o, s, r = 0, a = ht.expando, l = ht.cache, c = ut.attributes, u = ht.event.special; null != (n = t[r]); r++)
                if ((e || At(n)) && (o = n[a], s = o && l[o])) {
                    if (s.events)
                        for (i in s.events) u[i] ? ht.event.remove(n, i) : ht.removeEvent(n, i, s.handle);
        ...
        html: function (t) {
            return Mt(this, function (t) {
                ...
                if ("string" == typeof t && !te.test(t) && (ut.htmlSerialize || !Zt.test(t)) && (ut.leadingWhitespace || !Wt.test(t)) && !Ft[(zt.exec(t) || ["", ""])[1].toLowerCase()]) {
        ...
        ht.fn[t] = function (t) {
            for (var n, i = 0, o = [], s = ht(t), r = s.length - 1; r >= i; i++) n = i === r ? this : this.clone(!0), ht(s[i])[e](n), st.apply(o, n.get());
    ...
    ! function () {
        function e() {
            ...
            d.appendChild(l), c.style.cssText = "-webkit-box-sizing:border-box;box-sizing:border-box;position:relative;display:block;margin:auto;border:1px;padding:1px;top:1%;width:50%", n = o = a = !1, i = r = !0, t.getComputedStyle && (u = t.getComputedStyle(c), n = "1%" !== (u || {}).top, a = "2px" === (u || {}).marginLeft, o = "4px" === (u || {
                width: "4px"
        ...
        var n, i, o, s, r, a, l = nt.createElement("div"),
    ...
    t.getComputedStyle ? (de = function (e) {
        ...
        return n = n || de(t), "" !== (r = n ? n.getPropertyValue(e) || n[e] : void 0) && void 0 !== r || ht.contains(t.ownerDocument, t) || (r = ht.style(t, e)), n && !ut.pixelMarginRight() && le.test(r) && ae.test(e) && (i = a.width, o = a.minWidth, s = a.maxWidth, a.minWidth = a.maxWidth = a.width = r, r = n.width, a.width = i, a.minWidth = o, a.maxWidth = s), void 0 === r ? r : r + ""
    }) : ue.currentStyle && (de = function (t) {
        return t.currentStyle
    }, he = function (t, e, n) {
        var i, o, s, r, a = t.style;
        return n = n || de(t), null == (r = n ? n[e] : void 0) && a && a[e] && (r = a[e]), le.test(r) && !pe.test(e) && (i = a.left, o = t.runtimeStyle, (s = o && o.left) && (o.left = t.currentStyle.left), a.left = "fontSize" === e ? "1em" : r, r = a.pixelLeft + "px", a.left = i, s && (o.left = s)), void 0 === r ? r : r + "" || "auto"
    });
    var fe = /alpha\([^)]*\)/i,
        ge = /opacity\s*=\s*([^)]*)/i,
        me = /^(none|table(?!-c[ea]).+)/,
    ...
    ht.extend({
        ...
        style: function (t, e, n, i) {
            if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
                var o, s, r, a = ht.camelCase(e),
                    l = t.style;
                if (e = ht.cssProps[a] || (ht.cssProps[a] = O(a) || a), r = ht.cssHooks[e] || ht.cssHooks[a], void 0 === n) return r && "get" in r && void 0 !== (o = r.get(t, !1, i)) ? o : l[e];
                if ("string" === (s = typeof n) && (o = Pt.exec(n)) && o[1] && (n = h(t, e, o), s = "number"), null != n && n === n && ("number" === s && (n += o && o[3] || (ht.cssNumber[a] ? "" : "px")), ut.clearCloneStyle || "" !== n || 0 !== e.indexOf("background") || (l[e] = "inherit"), !(r && "set" in r && void 0 === (n = r.set(t, n, i))))) try {
                    l[e] = n
                } catch (t) { }
            }
        },
        css: function (t, e, n, i) {
            var o, s, r, a = ht.camelCase(e);
            return e = ht.cssProps[a] || (ht.cssProps[a] = O(a) || a), (r = ht.cssHooks[e] || ht.cssHooks[a]) && "get" in r && (s = r.get(t, !0, n)), void 0 === s && (s = he(t, e, i)), "normal" === s && e in we && (s = we[e]), "" === n || n ? (o = parseFloat(s), !0 === n || isFinite(o) ? o || 0 : s) : s
        }
        ...
        ht.cssHooks[e] = {
            ...
            set: function (t, n, i) {
                var o = i && de(t);
                return P(0, n, i ? I(t, e, i, ut.boxSizing && "border-box" === ht.css(t, "boxSizing", !1, o), o) : 0)
            }
        }
        ...
        set: function (t, e) {
            ...
            n.zoom = 1, (e >= 1 || "" === e) && "" === ht.trim(s.replace(fe, "")) && n.removeAttribute && (n.removeAttribute("filter"), "" === e || i && !i.filter) || (n.filter = fe.test(s) ? s.replace(fe, o) : s + " " + o)
        }
    }), ht.cssHooks.marginRight = D(ut.reliableMarginRight, function (t, e) {
        return e ? ce(t, {
            display: "inline-block"
        }, he, [t, "marginRight"]) : void 0
    }), ht.cssHooks.marginLeft = D(ut.reliableMarginLeft, function (t, e) {
        ...
        ht.cssHooks[t + e] = {
            expand: function (n) {
                for (var i = 0, o = {}, s = "string" == typeof n ? n.split(" ") : [n]; 4 > i; i++) o[t + It[i] + e] = s[i] || s[i - 2] || s[0];
                return o
            }
        ...
        css: function (t, e) {
            return Mt(this, function (t, e, n) {
                var i, o, s = {},
                    r = 0;
                if (ht.isArray(e)) {
                    for (i = de(t), o = e.length; o > r; r++) s[e[r]] = ht.css(t, e[r], !1, i);
                    return s
                }
        ...
        toggle: function (t) {
            return "boolean" == typeof t ? t ? this.show() : this.hide() : this.each(function () {
                jt(this) ? ht(this).show() : ht(this).hide()
            })
        }
    ...
    ht.Animation = ht.extend(q, {
        ...
        prefilters: [function (t, e, n) {
            ...
            if (ht.isEmptyObject(d)) "inline" === ("none" === c ? A(t.nodeName) : c) && (h.display = c);
                ...
                f ? "hidden" in f && (p = f.hidden) : f = ht._data(t, "fxshow", {}), s && (f.hidden = !p), p ? ht(t).show() : u.done(function () {
                    ht(t).hide()
                }), u.done(function () {
                    var e;
                ...
                for (i in d) r = R(p ? f[i] : 0, i, u), i in f || (f[i] = r.start, p && (r.end = r.start, r.start = "width" === i || "height" === i ? 1 : 0))
            }
        }],
        ...
        stop: function (t, e, n) {
            ...
            return "string" != typeof t && (n = e, e = t, t = void 0), e && !1 !== t && this.queue(t || "fx", []), this.each(function () {
                ...
                if (o) r[o] && r[o].stop && i(r[o]);
                    ...
                    for (o in r) r[o] && r[o].stop && _e.test(o) && i(r[o]);
        ...
        var t, e = ht.timers,
            n = 0;
        for (Te = ht.now(); n < e.length; n++)(t = e[n])() || e[n] !== t || e.splice(n--, 1);
        ...
        valHooks: {
            option: {
                get: function (t) {
                    ...
                    return null != e ? e : ht.trim(ht.text(t)).replace($e, " ")
                }
            },
            select: {
                get: function (t) {
                ...
                set: function (t, e) {
                    for (var n, i, o = t.options, s = ht.makeArray(e), r = o.length; r--;)
                        if (i = o[r], ht.inArray(ht.valHooks.option.get(i), s) > -1) try {
                            i.selected = n = !0
                        } catch (t) {
                            i.scrollHeight
                        } else i.selected = !1;
    ...
    var ke, Ne, Ae = ht.expr.attrHandle,
    ...
    ht.fn.extend({
        ...
        attr: function (t, e, n) {
            var i, o, s = t.nodeType;
            if (3 !== s && 8 !== s && 2 !== s) return void 0 === t.getAttribute ? ht.prop(t, e, n) : (1 === s && ht.isXMLDoc(t) || (e = e.toLowerCase(), o = ht.attrHooks[e] || (ht.expr.match.bool.test(e) ? Ne : ke)), void 0 !== n ? null === n ? void ht.removeAttr(t, e) : o && "set" in o && void 0 !== (i = o.set(t, n, e)) ? i : (t.setAttribute(e, n + ""), n) : o && "get" in o && null !== (i = o.get(t, e)) ? i : null == (i = ht.find.attr(t, e)) ? void 0 : i)
        },
        attrHooks: {
            type: {
                set: function (t, e) {
        ...
        removeAttr: function (t, e) {
            var n, i, o = 0,
                s = e && e.match($t);
            if (s && 1 === t.nodeType)
                for (; n = s[o++];) i = ht.propFix[n] || n, ht.expr.match.bool.test(n) ? Le && Oe || !De.test(n) ? t[i] = !1 : t[ht.camelCase("default-" + n)] = t[i] = !1 : ht.attr(t, n, ""), t.removeAttribute(Oe ? n : i)
        }
    }), Ne = {
        set: function (t, e, n) {
            return !1 === e ? ht.removeAttr(t, n) : Le && Oe || !De.test(n) ? t.setAttribute(!Oe && ht.propFix[n] || n, n) : t[ht.camelCase("default-" + n)] = t[n] = !0, n
        }
    }, ht.each(ht.expr.match.bool.source.match(/\w+/g), function (t, e) {
        var n = Ae[e] || ht.find.attr;
        Le && Oe || !De.test(e) ? Ae[e] = function (t, e, i) {
            var o, s;
            return i || (s = Ae[e], Ae[e] = o, o = null != n(t, e, i) ? e.toLowerCase() : null, Ae[e] = s), o
        } : Ae[e] = function (t, e, n) {
            return n ? void 0 : t[ht.camelCase("default-" + e)] ? e.toLowerCase() : null
        }
    }), Le && Oe || (ht.attrHooks.value = {
        set: function (t, e, n) {
            return ht.nodeName(t, "input") ? void (t.defaultValue = e) : ke && ke.set(t, e, n)
        }
    }), Oe || (ke = {
        set: function (t, e, n) {
    ...
    ht.fn.extend({
        addClass: function (t) {
            ...
            if ("string" == typeof t && t)
                for (e = t.match($t) || []; n = this[l++];)
                    if (o = F(n), i = 1 === n.nodeType && (" " + o + " ").replace(je, " ")) {
        ...
        toggleClass: function (t, e) {
            ...
            return "boolean" == typeof e && "string" === n ? e ? this.addClass(t) : this.removeClass(t) : ht.isFunction(t) ? this.each(function (n) {
                ...
                var e, i, o, s;
                if ("string" === n)
                    for (i = 0, o = ht(this), s = t.match($t) || []; e = s[i++];) o.hasClass(e) ? o.removeClass(e) : o.addClass(e);
        ...
        hasClass: function (t) {
            var e, n, i = 0;
            for (e = " " + t + " "; n = this[i++];)
                if (1 === n.nodeType && (" " + F(n) + " ").replace(je, " ").indexOf(e) > -1) return !0;
            return !1
        }
    ...
    ht.parseJSON = function (e) {
        ...
        var n, i = null,
            o = ht.trim(e + "");
        return o && !ht.trim(o.replace(Re, function (t, e, o, s) {
    ...
    ht.extend({
        ...
        ajaxSetup: function (t, e) {
            return e ? U(U(t, ht.ajaxSettings), e) : U(ht.ajaxSettings, t)
        },
        ajaxPrefilter: B(Ve),
        ajaxTransport: B(Ye),
        ajax: function (e, n) {
            function i(e, n, i, o) {
                var s, d, y, w, x, C = n;
                2 !== b && (b = 2, l && t.clearTimeout(l), u = void 0, a = o || "", T.readyState = e > 0 ? 4 : 0, s = e >= 200 && 300 > e || 304 === e, i && (w = Q(h, T, i)), w = V(h, w, T, s), s ? (h.ifModified && ((x = T.getResponseHeader("Last-Modified")) && (ht.lastModified[r] = x), (x = T.getResponseHeader("etag")) && (ht.etag[r] = x)), 204 === e || "HEAD" === h.type ? C = "nocontent" : 304 === e ? C = "notmodified" : (C = w.state, d = w.data, y = w.error, s = !y)) : (y = C, !e && C || (C = "error", 0 > e && (e = 0))), T.status = e, T.statusText = (n || C) + "", s ? g.resolveWith(p, [d, C, T]) : g.rejectWith(p, [T, C, y]), T.statusCode(v), v = void 0, c && f.trigger(s ? "ajaxSuccess" : "ajaxError", [T, h, s ? d : y]), m.fireWith(p, [T, C]), c && (f.trigger("ajaxComplete", [T, h]), --ht.active || ht.event.trigger("ajaxStop")))
            }
            "object" == typeof e && (n = e, e = void 0), n = n || {};
            var o, s, r, a, l, c, u, d, h = ht.ajaxSetup({}, n),
                p = h.context || h,
            ...
            if (g.promise(T).complete = m.add, T.success = T.done, T.error = T.fail, h.url = ((e || h.url || Ke) + "").replace(We, "").replace(Ue, Ze[1] + "//"), h.type = n.method || n.type || h.method || h.type, h.dataTypes = ht.trim(h.dataType || "*").toLowerCase().match($t) || [""], null == h.crossDomain && (o = Qe.exec(h.url.toLowerCase()), h.crossDomain = !(!o || o[1] === Ze[1] && o[2] === Ze[2] && (o[3] || ("http:" === o[1] ? "80" : "443")) === (Ze[3] || ("http:" === Ze[1] ? "80" : "443")))), h.data && h.processData && "string" != typeof h.data && (h.data = ht.param(h.data, h.traditional)), X(Ve, h, n, T), 2 === b) return T;
            (c = ht.event && h.global) && 0 == ht.active++ && ht.event.trigger("ajaxStart"), h.type = h.type.toUpperCase(), h.hasContent = !Xe.test(h.type), r = h.url, h.hasContent || (h.data && (r = h.url += (ze.test(r) ? "&" : "?") + h.data, delete h.data), !1 === h.cache && (h.url = qe.test(r) ? r.replace(qe, "$1_=" + He++) : r + (ze.test(r) ? "&" : "?") + "_=" + He++)), h.ifModified && (ht.lastModified[r] && T.setRequestHeader("If-Modified-Since", ht.lastModified[r]), ht.etag[r] && T.setRequestHeader("If-None-Match", ht.etag[r])), (h.data && h.hasContent && !1 !== h.contentType || n.contentType) && T.setRequestHeader("Content-Type", h.contentType), T.setRequestHeader("Accept", h.dataTypes[0] && h.accepts[h.dataTypes[0]] ? h.accepts[h.dataTypes[0]] + ("*" !== h.dataTypes[0] ? ", " + Ge + "; q=0.01" : "") : h.accepts["*"]);
            ...
            if (u = X(Ye, h, n, T)) {
                if (T.readyState = 1, c && f.trigger("ajaxSend", [T, h]), 2 === b) return T;
    ...
    ht.param = function (t, e) {
        ...
        serializeArray: function () {
            return this.map(function () {
                ...
                var t = this.type;
                return this.name && !ht(this).is(":disabled") && on.test(this.nodeName) && !nn.test(t) && (this.checked || !Ht.test(t))
            }).map(function (t, e) {
                var n = ht(this).val();
        ...
        if (!e.crossDomain || ut.cors) {
            ...
            return {
                send: function (i, o) {
                    ...
                    r.send(e.hasContent && e.data || null), n = function (t, i) {
                        var s, l, c;
                        if (n && (i || 4 === r.readyState))
                            if (delete rn[a], n = void 0, r.onreadystatechange = ht.noop, i) 4 !== r.readyState && r.abort();
                            else {
                    ...
                    }, e.async ? 4 === r.readyState ? t.setTimeout(n) : r.onreadystatechange = rn[a] = n : n()
                },
                abort: function () {
                    n && n(void 0, !0)
                }
    ...
    ht.ajaxSetup({
        ...
        jsonpCallback: function () {
            var t = ln.pop() || ht.expando + "_" + He++;
            return this[t] = !0, t
        }
    }), ht.ajaxPrefilter("json jsonp", function (e, n, i) {
        var o, s, r, a = !1 !== e.jsonp && (cn.test(e.url) ? "url" : "string" == typeof e.data && 0 === (e.contentType || "").indexOf("application/x-www-form-urlencoded") && cn.test(e.data) && "data");
        return a || "jsonp" === e.dataTypes[0] ? (o = e.jsonpCallback = ht.isFunction(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, a ? e[a] = e[a].replace(cn, "$1" + o) : !1 !== e.jsonp && (e.url += (ze.test(e.url) ? "&" : "?") + e.jsonp + "=" + o), e.converters["script json"] = function () {
            return r || ht.error(o + " was not called"), r[0]
        }, e.dataTypes[0] = "json", s = t[o], t[o] = function () {
            r = arguments
        }, i.always(function () {
            void 0 === s ? ht(t).removeProp(o) : t[o] = s, e[o] && (e.jsonpCallback = n.jsonpCallback, ln.push(o)), r && ht.isFunction(s) && s(r[0]), r = s = void 0
        }), "script") : void 0
    ...
    ht.fn.load = function (t, e, n) {
        ...
        var i, o, s, r = this,
            a = t.indexOf(" ");
        return a > -1 && (i = ht.trim(t.slice(a, t.length)), t = t.slice(0, a)), ht.isFunction(e) ? (n = e, e = void 0) : e && "object" == typeof e && (o = "POST"), r.length > 0 && ht.ajax({
            url: t,
            type: o || "GET",
            dataType: "html",
            data: e
        ...
        setOffset: function (t, e, n) {
            var i, o, s, r, a, l, c = ht.css(t, "position"),
                u = ht(t),
                d = {};
        ...
        offset: function (t) {
            ...
            var e, n, i = {
                ...
                o = this[0],
                s = o && o.ownerDocument;
            return s ? (e = s.documentElement, ht.contains(e, o) ? (void 0 !== o.getBoundingClientRect && (i = o.getBoundingClientRect()), n = tt(s), {
        ...
        ht.fn[t] = function (i) {
            return Mt(this, function (t, i, o) {
                var s = tt(t);
                return void 0 === o ? s ? e in s ? s[e] : s.document.documentElement[i] : t[i] : void (s ? s.scrollTo(n ? ht(s).scrollLeft() : o, n ? o : ht(s).scrollTop()) : t[i] = o)
            }, t, i, arguments.length, null)
        }
    }), ht.each(["top", "left"], function (t, e) {
        ht.cssHooks[e] = D(ut.pixelPosition, function (t, n) {
        ...
        ht.each({
            ...
            ht.fn[i] = function (i, o) {
                ...
                return Mt(this, function (e, n, i) {
                    var o;
                    return ht.isWindow(e) ? e.document.documentElement["client" + t] : 9 === e.nodeType ? (o = e.documentElement, Math.max(e.body["scroll" + t], o["scroll" + t], e.body["offset" + t], o["offset" + t], o["client" + t])) : void 0 === i ? ht.css(e, n, r) : ht.style(e, n, i, r)
                }, e, s ? i : void 0, s, null)
            }
        })
    }), ht.fn.extend({
    ...
    o.prototype = {
        ...
        _findParticles: function () {
            ...
            this.particles = [], this.options.parallaxElements && this.$element.find("[data-stellar-ratio]").each(function () {
                var n, o, s, r, a, l, c, u, d, h = t(this),
                    p = 0,
                    f = 0,
                    g = 0,
                    m = 0;
                ...
                e.options.showElement(h), h.data("stellar-startingLeft") ? (h.css("left", h.data("stellar-startingLeft")), h.css("top", h.data("stellar-startingTop"))) : (h.data("stellar-startingLeft", h.css("left")), h.data("stellar-startingTop", h.css("top"))), s = h.position().left, r = h.position().top, a = "auto" === h.css("margin-left") ? 0 : parseInt(h.css("margin-left"), 10), l = "auto" === h.css("margin-top") ? 0 : parseInt(h.css("margin-top"), 10), u = h.offset().left - a, d = h.offset().top - l, h.parents().each(function () {
                    var e = t(this);
        ...
        _findBackgrounds: function () {
            ...
            this.backgrounds = [], this.options.parallaxBackgrounds && (e = this.$element.find("[data-stellar-background-ratio]"), this.$element.data("stellar-background-ratio") && (e = e.add(this.$element)), e.each(function () {
                ...
                f.data("stellar-backgroundStartingLeft") ? d(f, f.data("stellar-backgroundStartingLeft"), f.data("stellar-backgroundStartingTop")) : (f.data("stellar-backgroundStartingLeft", g[0]), f.data("stellar-backgroundStartingTop", g[1])), a = "auto" === f.css("margin-left") ? 0 : parseInt(f.css("margin-left"), 10), l = "auto" === f.css("margin-top") ? 0 : parseInt(f.css("margin-top"), 10), c = f.offset().left - a - o, u = f.offset().top - l - s, f.parents().each(function () {
                    var e = t(this);
                    return !0 === e.data("stellar-offset-parent") ? (m = y, v = w, p = e, !1) : (y += e.position().left, void (w += e.position().top))
                }), e = f.data("stellar-horizontal-offset") !== i ? f.data("stellar-horizontal-offset") : p !== i && p.data("stellar-horizontal-offset") !== i ? p.data("stellar-horizontal-offset") : n.horizontalOffset, r = f.data("stellar-vertical-offset") !== i ? f.data("stellar-vertical-offset") : p !== i && p.data("stellar-vertical-offset") !== i ? p.data("stellar-vertical-offset") : n.verticalOffset, n.backgrounds.push({
                    $element: f,
                    $offsetParent: p,
        ...
        _repositionElements: function () {
            var t, e, n, i, o, s, r, a, l, c, u = this._getScrollLeft(),
    ...
    t.flexslider = function (n, i) {
        ...
        t.data(n, "flexslider", o), m = {
            ...
            asNav: {
                setup: function () {
                    o.asNav = !0, o.animatingTo = Math.floor(o.currentSlide / o.move), o.currentItem = o.currentSlide, o.slides.removeClass(r + "active-slide").eq(o.currentItem).addClass(r + "active-slide"), a ? (n._slider = o, o.slides.each(function () {
                        var e = this;
                        ...
                        var n = t(this),
                            i = n.index();
                        0 >= n.offset().left - t(o).scrollLeft() && n.hasClass(r + "active-slide") ? o.flexAnimate(o.getTarget("prev"), !0) : t(o.vars.asNavFor).data("flexslider").animating || n.hasClass(r + "active-slide") || (o.direction = o.currentItem < i ? "next" : "prev", o.flexAnimate(i, o.vars.pauseOnAction, !1, !0, !0))
                    })
                }
            },
            controlNav: {
                ...
                setupPaging: function () {
                    ...
                    if (o.controlNavScaffold = t('<ol class="' + r + "control-nav " + r + i + '"></ol>'), o.pagingCount > 1)
                        for (var a = 0; a < o.pagingCount; a++) {
                            if (void 0 === (n = o.slides.eq(a)).attr("data-thumb-alt") && n.attr("data-thumb-alt", ""), altText = "" !== n.attr("data-thumb-alt") ? altText = ' alt="' + n.attr("data-thumb-alt") + '"' : "", e = "thumbnails" === o.vars.controlNav ? '<img src="' + n.attr("data-thumb") + '"' + altText + "/>" : '<a href="#">' + s + "</a>", "thumbnails" === o.vars.controlNav && !0 === o.vars.thumbCaptions) {
            ...
            directionNav: {
                setup: function () {
                    ...
                    o.customDirectionNav ? o.directionNav = o.customDirectionNav : o.controlsContainer ? (t(o.controlsContainer).append(e), o.directionNav = t("." + r + "direction-nav li a", o.controlsContainer)) : (o.append(e), o.directionNav = t("." + r + "direction-nav li a", o)), m.directionNav.update(), o.directionNav.bind(c, function (e) {
                        e.preventDefault();
                        var n;
                        ("" === u || u === e.type) && (n = t(this).hasClass(r + "next") ? o.getTarget("next") : o.getTarget("prev"), o.flexAnimate(n, o.vars.pauseOnAction)), "" === u && (u = e.type), m.setToClearWatchedEvent()
                    })
                },
                update: function () {
                    var t = r + "disabled";
            ...
            pausePlay: {
                setup: function () {
                    ...
                    o.controlsContainer ? (o.controlsContainer.append(e), o.pausePlay = t("." + r + "pauseplay a", o.controlsContainer)) : (o.append(e), o.pausePlay = t("." + r + "pauseplay a", o)), m.pausePlay.update(o.vars.slideshow ? r + "pause" : r + "play"), o.pausePlay.bind(c, function (e) {
                        e.preventDefault(), ("" === u || u === e.type) && (t(this).hasClass(r + "pause") ? (o.manualPause = !0, o.manualPlay = !1, o.pause()) : (o.manualPause = !1, o.manualPlay = !0, o.play())), "" === u && (u = e.type), m.setToClearWatchedEvent()
                    })
                },
                update: function (t) {
                ...
                a ? (n.style.msTouchAction = "none", n._gesture = new MSGesture, n._gesture.target = n, n.addEventListener("MSPointerDown", function (t) {
                    ...
                    if (e) {
                        var o = -t.translationX,
                            a = -t.translationY;
                        return w += d ? a : o, r = w, m = d ? Math.abs(w) < Math.abs(-o) : Math.abs(w) < Math.abs(-a), t.detail === t.MSGESTURE_FLAG_INERTIA ? void setImmediate(function () {
                            n._gesture.stop()
                        }) : void ((!m || Number(new Date) - l > 500) && (t.preventDefault(), !f && e.transitions && (e.vars.animationLoop || (r = w / (0 === e.currentSlide && 0 > w || e.currentSlide === e.last && w > 0 ? Math.abs(w) / s + 2 : 1)), e.setProps(i + r, "setTouch"))))
                    }
                }, !1), n.addEventListener("MSGestureEnd", function (n) {
                    n.stopPropagation();
                    var o = n.target._slider;
                    if (o) {
                        if (o.animatingTo === o.currentSlide && !m && null !== r) {
                            var a = h ? -r : r,
                                c = a > 0 ? o.getTarget("next") : o.getTarget("prev");
                            o.canAdvance(c) && (Number(new Date) - l < 550 && Math.abs(a) > 50 || Math.abs(a) > s / 2) ? o.flexAnimate(c, o.vars.pauseOnAction) : f || o.flexAnimate(o.currentSlide, o.vars.pauseOnAction, !0)
                        }
                        t = null, e = null, r = null, i = null, w = 0
                    }
                }, !1)) : (c = function (r) {
                    ...
                    v = n.touches[0].pageX, y = n.touches[0].pageY, r = d ? t - y : t - v;
                    (!(m = d ? Math.abs(r) < Math.abs(v - e) : Math.abs(r) < Math.abs(y - e)) || Number(new Date) - l > 500) && (n.preventDefault(), !f && o.transitions && (o.vars.animationLoop || (r /= 0 === o.currentSlide && 0 > r || o.currentSlide === o.last && r > 0 ? Math.abs(r) / s + 2 : 1), o.setProps(i + r, "setTouch")))
                }, g = function (a) {
                    if (n.removeEventListener("touchmove", u, !1), o.animatingTo === o.currentSlide && !m && null !== r) {
                        var c = h ? -r : r,
                            d = c > 0 ? o.getTarget("next") : o.getTarget("prev");
                        o.canAdvance(d) && (Number(new Date) - l < 550 && Math.abs(c) > 50 || Math.abs(c) > s / 2) ? o.flexAnimate(d, o.vars.pauseOnAction) : f || o.flexAnimate(o.currentSlide, o.vars.pauseOnAction, !0)
                    }
                    n.removeEventListener("touchend", g, !1), t = null, e = null, r = null, i = null
        ...
        }, o.flexAnimate = function (e, n, i, s, a) {
    ...
    i.Defaults = {
        ...
        return e.wrap('<div class="owl-video-wrapper"' + r + "></div>"), this._core.settings.lazyLoad && (l = "data-src", c = "owl-lazy"), a.length ? (d(a.attr(l)), a.remove(), !1) : void ("youtube" === n.type ? (s = "http://img.youtube.com/vi/" + n.id + "/hqdefault.jpg", d(s)) : "vimeo" === n.type && t.ajax({
            type: "GET",
        ...
        e.prototype.add = function (t) {
            ...
            for (var s in t) {
                ...
                for (var a in this.waypoints[s]) {
                    var l, c, u, d, h, p = this.waypoints[s][a],
                        f = p.options.offset,
                        g = p.triggerPoint,
                        m = 0,
                        v = null == g;
